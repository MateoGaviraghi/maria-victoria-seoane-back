-- CreateEnum
CREATE TYPE "Role" AS ENUM ('SUPER_ADMIN', 'OWNER', 'STUDENT');

-- CreateEnum
CREATE TYPE "StudentStatus" AS ENUM ('REGISTERED', 'IN_CART', 'PENDING_PAYMENT', 'PAID', 'IN_PROGRESS', 'COMPLETED');
...
-- CreateEnum
CREATE TYPE "MessageStatus" AS ENUM ('UNREAD', 'READ', 'ANSWERED', 'ARCHIVED');
...
CREATE TABLE "users" (
    ...
    "studentStatus" "StudentStatus" NOT NULL DEFAULT 'REGISTERED',
...
CREATE TABLE "course_coupons" (
    ...
    CONSTRAINT "course_coupons_pkey" PRIMARY KEY ("couponId","courseId")
);
...
-- AddForeignKey
ALTER TABLE "course_coupons" ADD CONSTRAINT "course_coupons_couponId_fkey" FOREIGN KEY ("couponId") REFERENCES "coupons"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "course_coupons" ADD CONSTRAINT "course_coupons_courseId_fkey" FOREIGN KEY ("courseId") REFERENCES "courses"("id") ON DELETE CASCADE ON UPDATE CASCADE;
